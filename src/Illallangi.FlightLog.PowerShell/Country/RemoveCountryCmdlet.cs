namespace Illallangi.FlightLog.PowerShell.Country
{
    ...
    public sealed class RemoveCountryCmdlet : FlightLogCmdlet<ICountry>
    {
        ...
        {
            foreach (var o in this.Repository.Retrieve(new FlightLog.PowerShell.Country { Id = this.Id, Name = this.Name }).ToList().Where(o => this.ShouldProcess(o.ToString(), VerbsCommon.Remove)))
            {
